...
UPDATE  Adress_Book SET AdressBookName='FamilyAddressBook' , Type = 'Family' WHERE FirstName ='Ruchita' or FirstName='Ritu';
UPDATE  Adress_Book SET AdressBookName='FriendAddressBook' , Type = 'Friend' WHERE  FirstName='Ganesh';
...
INSERT INTO AddressBook VALUES ('Shubham'),('Paras');
